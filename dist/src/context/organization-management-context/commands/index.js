...
__exportStar(require("./sync-admin-permissions.handler"), exports);
...
const sync_admin_permissions_handler_1 = require("./sync-admin-permissions.handler");
exports.COMMAND_HANDLERS = [
    ...
    sync_admin_permissions_handler_1.SyncAdminPermissionsHandler,
];
