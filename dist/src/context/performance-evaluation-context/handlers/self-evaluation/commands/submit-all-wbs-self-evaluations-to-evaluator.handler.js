...
var SubmitAllWbsSelfEvaluationsToEvaluatorHandler_1;
...
class SubmitAllWbsSelfEvaluationsToEvaluatorCommand {
    employeeId;
    periodId;
    submittedBy;
...
exports.SubmitAllWbsSelfEvaluationsToEvaluatorCommand = SubmitAllWbsSelfEvaluationsToEvaluatorCommand;
let SubmitAllWbsSelfEvaluationsToEvaluatorHandler = SubmitAllWbsSelfEvaluationsToEvaluatorHandler_1 = class SubmitAllWbsSelfEvaluationsToEvaluatorHandler {
    ...
    async execute(command) {
        ...
        this.logger.log('직원의 전체 WBS 자기평가 제출 시작 (피평가자 → 1차 평가자)', {
            employeeId,
            periodId,
        });
...
exports.SubmitAllWbsSelfEvaluationsToEvaluatorHandler = SubmitAllWbsSelfEvaluationsToEvaluatorHandler;
exports.SubmitAllWbsSelfEvaluationsToEvaluatorHandler = SubmitAllWbsSelfEvaluationsToEvaluatorHandler = SubmitAllWbsSelfEvaluationsToEvaluatorHandler_1 = __decorate([
    (0, common_1.Injectable)(),
    (0, cqrs_1.CommandHandler)(SubmitAllWbsSelfEvaluationsToEvaluatorCommand),
