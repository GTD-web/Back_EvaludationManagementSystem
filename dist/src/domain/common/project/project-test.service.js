...
let ProjectTestService = class ProjectTestService {
    ...
    async 테스트용_목데이터를_생성한다() {
        ...
        console.log(...oo_oo(`1858424956_167_4_167_55_4`, `프로젝트 생성 완료: ${savedProjects.length}개`));
        console.log(...oo_oo(`1858424956_168_4_170_5_4`, `managerId가 UUID로 변환된 프로젝트: ${savedProjects.filter((p) => p.managerId).length}개`));
