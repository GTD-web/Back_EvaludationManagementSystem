...
let SeedDataController = SeedDataController_1 = class SeedDataController {
    ...
    async generateSeedDataWithRealData(config, req) {
        ...
        if (config.stateDistribution) {
            console.log(...oo_oo(`3356342747_116_6_119_7_4`, '[Controller] stateDistribution.selfEvaluationProgress:', JSON.stringify(config.stateDistribution.selfEvaluationProgress)));
        }
        if (config.includeCurrentUserAsEvaluator) {
            console.log(...oo_oo(`3356342747_123_6_123_64_4`, '[Controller] 현재 사용자를 평가자로 등록:', req.user?.id));
        }
