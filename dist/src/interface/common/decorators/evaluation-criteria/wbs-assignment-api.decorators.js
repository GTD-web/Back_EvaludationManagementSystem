...
- 감사 정보: 생성일시, 수정일시, 생성자, 수정자 정보 자동 기록`,
    ...
    type: wbs_assignment_dto_1.CreateWbsAssignmentDto,
...
const CancelWbsAssignmentByWbs = () => (0, common_1.applyDecorators)((0, common_1.Delete)('wbs-item/:wbsItemId'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({
    ...
    description: `WBS ID를 사용하여 기존 WBS 할당을 취소(소프트 삭제)합니다. 할당 취소 시 관련 데이터 정리 및 멱등성 보장을 수행합니다.

**동작:**
- employeeId, wbsItemId, projectId, periodId로 할당을 찾아 취소
- 소프트 삭제: 실제 레코드 삭제가 아닌 deletedAt 필드를 업데이트
- 자기평가 정리: 해당 WBS 항목의 자기평가 자동 삭제
...
- 자기평가 자동 삭제: 해당 WBS 항목의 자기평가가 자동으로 삭제됨
- 여러 자기평가 삭제: 해당 WBS에 여러 자기평가가 있는 경우 모두 삭제됨
...
- 대량 할당 후 전체 취소: 모든 할당을 취소하면 자기평가와 평가기준도 모두 삭제됨
- 트랜잭션 보장: 할당 취소, 자기평가 삭제, 평가기준 정리가 원자적으로 수행됨`,
    ...
    type: wbs_assignment_dto_1.CancelWbsAssignmentByWbsDto,
...
exports.CancelWbsAssignmentByWbs = CancelWbsAssignmentByWbs;
const GetWbsAssignmentList = () => (0, common_1.applyDecorators)((0, common_1.Get)(), (0, swagger_1.ApiOperation)({
...
exports.GetWbsAssignmentList = GetWbsAssignmentList;
const GetWbsAssignmentDetail = () => (0, common_1.applyDecorators)((0, common_1.Get)('detail'), (0, swagger_1.ApiOperation)({
...
- 잘못된 UUID - periodId: 잘못된 UUID 형식의 periodId 전달 시 400 에러`,
    ...
    status: 200,
    description: 'WBS 할당 상세 정보가 성공적으로 조회되었습니다. (관련 정보 모두 포함)',
    schema: {
        type: 'object',
        properties: {
            id: {
...
exports.GetWbsAssignmentDetail = GetWbsAssignmentDetail;
const GetEmployeeWbsAssignments = () => (0, common_1.applyDecorators)((0, common_1.Get)('employee/:employeeId/period/:periodId'), (0, swagger_1.ApiOperation)({
...
exports.GetEmployeeWbsAssignments = GetEmployeeWbsAssignments;
const GetProjectWbsAssignments = () => (0, common_1.applyDecorators)((0, common_1.Get)('project/:projectId/period/:periodId'), (0, swagger_1.ApiOperation)({
...
exports.GetProjectWbsAssignments = GetProjectWbsAssignments;
const GetWbsItemAssignments = () => (0, common_1.applyDecorators)((0, common_1.Get)('wbs-item/:wbsItemId/period/:periodId'), (0, swagger_1.ApiOperation)({
...
exports.GetWbsItemAssignments = GetWbsItemAssignments;
const GetUnassignedWbsItems = () => (0, common_1.applyDecorators)((0, common_1.Get)('unassigned'), (0, swagger_1.ApiOperation)({
...
- 존재하지 않는 직원: 존재하지 않는 직원 ID로 요청 시 400 에러`,
    ...
    name: 'employeeId',
    description: '직원 ID (UUID 형식, 선택사항) - 제공 시 해당 직원에게 할당되지 않은 WBS만 조회',
    required: false,
    type: 'string',
    format: 'uuid',
    example: 'a1b2c3d4-e5f6-4a7b-8c9d-0e1f2a3b4c5d',
    ...
    status: 200,
    description: '할당되지 않은 WBS 항목 목록이 성공적으로 조회되었습니다. (전체 정보 포함)',
    schema: {
        type: 'object',
        properties: {
            wbsItems: {
...
exports.GetUnassignedWbsItems = GetUnassignedWbsItems;
const BulkCreateWbsAssignments = () => (0, common_1.applyDecorators)((0, common_1.Post)('bulk'), (0, common_1.HttpCode)(common_1.HttpStatus.CREATED), (0, swagger_1.ApiOperation)({
    summary: 'WBS 대량 할당',
...
- 최소 1개 검증: 할당 목록은 최소 1개 이상 필수`,
    ...
    type: wbs_assignment_dto_1.BulkCreateWbsAssignmentDto,
...
exports.BulkCreateWbsAssignments = BulkCreateWbsAssignments;
const ResetPeriodWbsAssignments = () => (0, common_1.applyDecorators)((0, common_1.Delete)('period/:periodId'), (0, swagger_1.ApiOperation)({
...
exports.ResetPeriodWbsAssignments = ResetPeriodWbsAssignments;
const ResetProjectWbsAssignments = () => (0, common_1.applyDecorators)((0, common_1.Delete)('project/:projectId/period/:periodId'), (0, swagger_1.ApiOperation)({
...
exports.ResetProjectWbsAssignments = ResetProjectWbsAssignments;
const ResetEmployeeWbsAssignments = () => (0, common_1.applyDecorators)((0, common_1.Delete)('employee/:employeeId/period/:periodId'), (0, swagger_1.ApiOperation)({
...
- 트랜잭션 보장: 순서 변경 중 오류 시 롤백 처리`,
    ...
    type: wbs_assignment_dto_1.ChangeWbsAssignmentOrderByWbsDto,
...
exports.ChangeWbsAssignmentOrderByWbs = ChangeWbsAssignmentOrderByWbs;
const CreateAndAssignWbs = () => (0, common_1.applyDecorators)((0, common_1.Post)('create-and-assign'), (0, common_1.HttpCode)(common_1.HttpStatus.CREATED), (0, swagger_1.ApiOperation)({
...
- 감사 정보: 생성일시, 수정일시, 생성자, 수정자 정보 자동 기록`,
    ...
    type: wbs_assignment_dto_1.CreateAndAssignWbsDto,
...
exports.CreateAndAssignWbs = CreateAndAssignWbs;
const CreateAndAssignWbsBetween = () => (0, common_1.applyDecorators)((0, common_1.Post)('create-and-assign-between/:previousWbsItemId/:nextWbsItemId'), (0, common_1.HttpCode)(common_1.HttpStatus.CREATED), (0, swagger_1.ApiOperation)({
...
- 완료된 평가기간 제한: 완료된 평가기간에 할당 생성 시 422 에러`,
    ...
    description: '이전 WBS 항목 ID (이 WBS 다음에 새 WBS가 추가됨, "none"을 전달하면 처음에 추가)',
    type: 'string',
    example: 'b2c3d4e5-f6a7-4b8c-9d0e-1f2a3b4c5d6e',
}), (0, swagger_1.ApiParam)({
    name: 'nextWbsItemId',
    description: '다음 WBS 항목 ID (이 WBS 이전에 새 WBS가 추가됨, "none"을 전달하면 마지막에 추가)',
    type: 'string',
    example: 'c3d4e5f6-a7b8-4b9c-0d1e-2f3a4b5c6d7e',
}), (0, swagger_1.ApiBody)({
    type: wbs_assignment_dto_1.CreateAndAssignWbsBetweenDto,
    ...
    status: 404,
    description: '직원, 프로젝트, 평가기간 또는 참조 WBS 항목을 찾을 수 없습니다.',
}), (0, swagger_1.ApiResponse)({
    status: 409,
    description: '중복된 할당입니다. (동일한 직원-WBS-프로젝트-평가기간 조합)',
}), (0, swagger_1.ApiResponse)({
...
exports.CreateAndAssignWbsBetween = CreateAndAssignWbsBetween;
const UpdateWbsItemTitle = () => (0, common_1.applyDecorators)((0, common_1.Patch)('wbs-item/:wbsItemId/title'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({
...
- 특수문자 포함: 특수문자가 포함된 제목으로 수정 가능`,
    ...
    type: wbs_assignment_dto_1.UpdateWbsItemTitleDto,
...
exports.UpdateWbsItemTitle = UpdateWbsItemTitle;
//# sourceMappingURL=wbs-assignment-api.decorators.js.map