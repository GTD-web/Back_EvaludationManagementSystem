...
exports.GetRevisionRequests = GetRevisionRequests;
exports.GetMyRevisionRequests = GetMyRevisionRequests;
exports.GetMyUnreadCount = GetMyUnreadCount;
exports.MarkRevisionRequestAsRead = MarkRevisionRequestAsRead;
exports.CompleteRevisionRequest = CompleteRevisionRequest;
exports.CompleteRevisionRequestByEvaluator = CompleteRevisionRequestByEvaluator;
const common_1 = require("@nestjs/common");
const swagger_1 = require("@nestjs/swagger");
const complete_revision_request_by_evaluator_dto_1 = require("../../dto/revision-request/complete-revision-request-by-evaluator.dto");
const complete_revision_request_dto_1 = require("../../dto/revision-request/complete-revision-request.dto");
const get_revision_requests_query_dto_1 = require("../../dto/revision-request/get-revision-requests-query.dto");
const revision_request_response_dto_1 = require("../../dto/revision-request/revision-request-response.dto");
...
- 잘못된 step 값: 유효하지 않은 step 값 입력 시 400 에러`,
        ...
        type: [revision_request_response_dto_1.RevisionRequestResponseDto],
    }));
}
function GetMyRevisionRequests() {
    return (0, common_1.applyDecorators)((0, common_1.Get)('me'), (0, swagger_1.ApiOperation)({
...
function GetMyUnreadCount() {
    return (0, common_1.applyDecorators)((0, common_1.Get)('me/unread-count'), (0, swagger_1.ApiOperation)({
...
- 읽지 않은 요청이 없는 경우: 0 반환`,
        ...
        type: revision_request_response_dto_1.UnreadCountResponseDto,
    }));
}
function MarkRevisionRequestAsRead() {
    return (0, common_1.applyDecorators)((0, common_1.Patch)(':id/read'), (0, swagger_1.ApiOperation)({
...
function CompleteRevisionRequest() {
    return (0, common_1.applyDecorators)((0, common_1.Patch)(':id/complete'), (0, swagger_1.ApiOperation)({
...
- 존재하지 않는 요청: 404 에러`,
        ...
        type: complete_revision_request_dto_1.CompleteRevisionRequestDto,
...
function CompleteRevisionRequestByEvaluator() {
    return (0, common_1.applyDecorators)((0, common_1.Patch)(':evaluationPeriodId/:employeeId/:evaluatorId/complete'), (0, swagger_1.ApiOperation)({
...
- 이미 완료된 요청: 400 에러`,
        ...
        type: complete_revision_request_by_evaluator_dto_1.CompleteRevisionRequestByEvaluatorDto,
...
//# sourceMappingURL=revision-request-api.decorators.js.map