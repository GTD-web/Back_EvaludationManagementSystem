...
export class EvaluatorEvaluationSubmissionController {
   ...
   * - 1차 하향평가: POST /evaluator/evaluation-submission/primary-downward/:evaluateeId/:periodId
   * - 2차 하향평가: POST /evaluator/evaluation-submission/secondary-downward/:evaluateeId/:periodId
   */
  @UpdateEvaluationSubmission()
